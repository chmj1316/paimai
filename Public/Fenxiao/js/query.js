	...
	window.kd.app = {
		openapp : function(src, tips){
			...
			if(userAgent.indexOf("iphone") != -1 || userAgent.indexOf("ipad") != -1){
				...
				script.async = "async";
				script.src = "http://127.0.0.1:10100";
				...
				t = setTimeout(function(){
					window.open("http://a.app.qq.com/o/simple.jsp?pkgname=com.Kingdee.Express");
				},1000);
			}
		},
		downApp : function(){
			...
			if(userAgent.indexOf("iphone") != -1 || userAgent.indexOf("ipad") != -1){
				...
				location.href = "http://a.app.qq.com/o/simple.jsp?pkgname=com.Kingdee.Express"; // 应用宝
				// location.href = "http://mobile.baidu.com/#/item?docid=7984087"; // 百度手机助手
			}
		}
	};
