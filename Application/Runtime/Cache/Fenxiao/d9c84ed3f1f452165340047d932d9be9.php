    ...
    <body>
        ...
        <section class="xzshdz_main auto">
            <div class="xzshdz_main">
                <span><a href="<?php echo U('User/zhuanInter');?>">积分转赠</a></span>
                <span><a href="<?php echo U('User/zhuanMoney');?>" class="xz">资金转赠</a></span>
            </div>
            <ul>
                <li class="fix">
                    <p>累计数量：</p>
                    <span><?php echo ($user_info['fx_count']); ?></span>
                </li>
                <li class="fix">
                    <p>现有数量：</p>
                    <span id="nowmoney"><?php echo ($user_info['fx_money']); ?></span>
                </li>
                <li class="fix">
                    <p>可用数量：</p>
                    <span id="myliveMoney" data-moneys="<?php echo ($user_info['fx_money']); ?>"><?php echo ($user_info['fx_money']); ?></span>
                </li>
                <li class="fix">
                    <p>获赠人ID：</p>
                    <span>
                ...
                <li class="fix">
                    <p>转赠数量：</p>
                    <span>
                        <input type="number" class="wbk" id="moneysAmount" placeholder="最多转赠数量：<?php echo ($user_info['fx_money']); ?>">
                    </span>
                </li>
            </ul>
            <dl>
