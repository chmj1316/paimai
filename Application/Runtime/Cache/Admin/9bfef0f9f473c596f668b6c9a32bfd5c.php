...
<div class="container">
        ...
        <div class="mright">
            ...
            <div class="mrbot">
            	<div class="mrbot1">
                    ...
                    <div class="mrnr1">
                    	<form>
	<?php if(IS_ROOT): ?><div class="hdtop">
    ...
    <table width="910" border="0" cellspacing="1" cellpadding="0" class="table1 tab">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><?php echo ($cateType[$v['type']]); ?></td>
                <td align="center"><?php echo ($v['display']?'显示':'隐藏'); ?></td>
                <td align="center"><?php echo ($v['sort']); ?></td>
                <td align="center">
                    <?php if(($v['setting']['allow_child']) == "1"): ?><a href="<?php echo U('add?pid='. $v['id']);?>" class="xga">添加子栏目</a>|<?php endif; ?>
