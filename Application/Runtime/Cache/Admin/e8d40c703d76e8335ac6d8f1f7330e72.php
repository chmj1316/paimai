...
<div class="container">
        ...
        <div class="mright">
            ...
            <div class="mrbot">
            	<div class="mrbot1">
                    ...
                    <div class="mrnr1">
                    		<div class="hdtop">
    	<a href="<?php echo U('index');?>" class="tja">返回列表</a>
		<?php if($banner_info['type']==2 || IS_ROOT): ?><a href="<?php echo U('dAdd?bid='. $bid);?>" class="tja">添 加</a><?php endif; ?>
        <div class="clear"></div>
    </div>
    <div class="hdbot">
    <style media="screen">
    ...
    <table width="910" border="0" cellspacing="1" cellpadding="0" class="table1 tab">
        <tr class="head910">
			...
			<?php if(($banner_info['allow_image']) == "1"): ?><td align="center">广告图片</td><?php endif; ?>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
				...
				<?php if(($banner_info['allow_image']) == "1"): ?><td align="center"><img src="<?php echo image($v['image']);?>" width="100" /></td><?php endif; ?>
                <td align="center"><?php echo ($v['sort']); ?></td>
                <td align="center">
                    <a href="<?php echo U('dEdit?id='. $v['id']);?>" class="xga">修改</a>
					<?php if($banner_info['type']==2 || IS_ROOT): ?>|
                    <a href="javascript:if(confirm('确认要执行该操作吗?')){location.href='<?php echo U('dDel?id='. $v['id']);?>'}" class="xga">删除</a><?php endif; ?>
                </td>
