...
<table width="900" border="0" cellspacing="0" cellpadding="0" class="table">
    <tr>
        <td class="td1" align="right">等级名称：</td>
        <td class="ms">
            <input type="text" name="name" value="<?php echo ((isset($info['name']) && ($info['name'] !== ""))?($info['name']):''); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">每天领取红包数：</td>
        <td class="ms">
            <input type="text" name="lqshu" value="<?php echo ($info['lqshu']); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">升级倍数：</td>
        <td class="ms">
            <input type="text" name="beishu" value="<?php echo ($info['beishu']); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">升级直推数：</td>
        <td class="ms">
            <input type="text" name="zhituishu" value="<?php echo ($info['zhituishu']); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">最小红包金额：</td>
        <td class="ms">
            <input type="text" name="min_price" value="<?php echo ($info['min_price']); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">最大红包金额：</td>
        <td class="ms">
            <input type="text" name="max_price" value="<?php echo ($info['max_price']); ?>" class="inputt input" />
        </td>
    </tr>
    <tr>
        ...
        <td class="ms">
            <select class="select" name="status">
                    ...
                    <option value="0" <?php if(($info['status']) == "0"): ?>selected="selected"<?php endif; ?>>关闭</option>
            </select>
            （状态）
        </td>
    </tr>
