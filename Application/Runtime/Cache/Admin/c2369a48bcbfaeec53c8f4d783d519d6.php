...
<table width="900" border="0" cellspacing="0" cellpadding="0" class="table">
    ...
    <tr>
        <td class="td1" align="right">已领红包数：</td>
        <td class="ms">
            <input type="text" value="<?php echo ($info['fx_hb_yl_s']); ?>" readonly="readonly" class="inputt input" />
        </td>
    </tr>
    <tr>
        <td class="td1" align="right">未领红包数：</td>
        <td class="ms">
            <input type="text" value="<?php echo ($info['fx_hb_wl_s']); ?>" readonly="readonly" class="inputt input" />
        </td>
    </tr>
    <tr>
